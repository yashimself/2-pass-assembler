...
//                System.out.println("\n\nMOT Table:\n");
//                System.out.println("Mnemonic"+"\t"+"Type"+"\t"+"Opcode"+"\t"+"Size"+"\n");
//                for(i=0;i<9;i++){
//                    System.out.println(Mnemonic[i]+"\t"+Type[i]+"\t"+Opcode[i]+"\t"+Size[i]);
//                }
            }
             catch (IOException e) {
                e.printStackTrace();
                                ...
                                if (inst[1].contains(",")) {
                                    ...
                                    if (tempstring[0].equals(Registers[0])) {
                                        if (!tempstring[1].equals(Registers[0])) {
                                            String temp = "(" + Type[i] + "," + Opcode[i] + ")" + "(" + Registers.length + ")" + "(" + "S" + "," + q + ")";
                                    ...
                                    String temp = "(" + Type[i] + "," + Opcode[i] + ")" + "(" + "S" + "," + q + ")";
                                    intermediate.add(temp);
                                        if(!(Arrays.stream(added).anyMatch(tempstring[1]::equals))){
                                            String syminp = q +"\t"+tempstring[1]+"\t"+LC;
                                            Symbols.add(syminp);
